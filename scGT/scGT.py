# The network architecture is adapted based on Nodeformer
import math,os
import torch
import numpy as np
...
class scGT(nn.Module):
    '''
    scGT model implementation, based off Nodeformer
    '''
